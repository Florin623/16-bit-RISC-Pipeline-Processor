...
REM
REM Generated by Vivado on Sat Apr 13 16:21:39 +0300 2024
...
echo "xvlog --incr --relax -L uvm -prj Golden_Model_TB_vlog.prj"
call xvlog  --incr --relax -L uvm -prj Golden_Model_TB_vlog.prj -log xvlog.log
